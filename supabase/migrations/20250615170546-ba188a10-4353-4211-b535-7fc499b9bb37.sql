...
-- Create policy to allow authenticated users to delete resources
CREATE POLICY "Allow authenticated users to delete knowledge resources" ON knowledge_resources
